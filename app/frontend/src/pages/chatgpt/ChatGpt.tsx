...
import { chat, Approaches, AskResponse, ChatRequest, ChatTurn, refreshIndex, getSpeechApi, SearchTypes,
...
const ChatGpt = () => {
    ...
    const makeApiRequest = async (question: string) => {
        ...
        try {
            ...
            const result = await chat(request, String(selectedItem?.key), String(selectedIndex), question);
