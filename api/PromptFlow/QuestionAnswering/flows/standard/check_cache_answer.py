...
def checkCacheAnswer(question:str, embeddedQuestion:object, indexType: str, indexNs:str, conn:CustomConnection):
  try:
    ...
    kbSearch = performKbCogVectorSearch(embeddedQuestion, 'vectorQuestion', SearchService, SearchKey, 
      indexType, indexNs, KbIndexName, 1, ["id", "question", "indexType", "indexName", "answer"])
